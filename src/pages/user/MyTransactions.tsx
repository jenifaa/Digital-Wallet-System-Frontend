...
export default function MyTransactions() {
  ...
  const getTransactionIcon = (type: string) => {
    switch (type) {
      ...
      case "CASH_OUT":
        return <BadgeDollarSign className="size-4 text-orange-400" />;

      default:
        return <Wallet className="size-4 text-indigo-400" />;
    }
  };
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div>
                ...
                <CardDescription className="text-slate-400">
                  Advanced filters, sorting, and export for all wallet
                  activities.
                </CardDescription>
              </div>
              <Button
