      ...
      <section className="mx-auto w-11/12 max-w-7xl py-20">
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl border bg-card p-6 shadow-sm">
            <p className="text-3xl font-bold text-slate-500">6+</p>
            <p className="mt-2 text-sm font-medium text-muted-foreground">
              connected service areas
            </p>
          </div>
          <div className="rounded-2xl border bg-card p-6 shadow-sm">
            <p className="text-3xl font-bold text-slate-500">24/7</p>
            <p className="mt-2 text-sm font-medium text-muted-foreground">
              digital support access
            </p>
          </div>
          <div className="rounded-2xl border bg-card p-6 shadow-sm">
            <p className="text-3xl font-bold text-slate-500">Secure</p>
            <p className="mt-2 text-sm font-medium text-muted-foreground">
