              ...
              <div className="space-y-4 pointer-events-none opacity-80">
                <div>
                  ...
                  <div className="flex items-center gap-3 bg-slate-50 border border-slate-100 rounded-xl px-4 py-3">
                    ...
                    <span className="text-sm text-slate-400 font-medium">johndoe@mail.com</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 bg-slate-50 border border-slate-100 rounded-xl px-4 py-3">
                    ...
                    <span className="text-sm text-slate-300 font-medium">Card number</span>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="space-y-3">
                  <div className="flex items-center justify-between gap-4 pb-2 border-b border-slate-100">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-black text-slate-700">Bill Chanky</span>
                    </div>
                    <span className="text-[10px] font-black text-emerald-500">$23.00</span>
                  </div>
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-2">
                      <div className="h-2 w-2 rounded-full bg-blue-500" />
                      <span className="text-[10px] font-black text-slate-700">Alesana Inc</span>
                    </div>
                    <span className="text-[10px] font-black text-emerald-500">$23.00</span>
                  </div>
                </div>
                ...
                <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[9px] font-black tracking-tighter uppercase text-slate-900">Cyber Bank</span>
                  </div>
                </div>
              </motion.div>
            </div>
              ...
              <div className="absolute w-70 h-45 sm:w-[320px] sm:h-50 rounded-3xl bg-linear-to-br from-slate-900 via-[#1F2340] to-slate-950 p-6 text-white shadow-xl transform -rotate-12 -translate-x-8 translate-y-2 transition duration-500 group-hover:-rotate-6 group-hover:-translate-x-12">
                <div className="flex flex-col h-full justify-between">
                  <div className="flex justify-between items-start">
                    ...
                    <span className="text-[10px] font-bold tracking-widest text-white/40 uppercase">VV 341</span>
                  </div>
                  <div className="space-y-1">
                    <p className="text-xs font-medium tracking-widest text-slate-400">EXP 09/24</p>
                    <p className="text-sm sm:text-base font-mono tracking-extrawide">•••• •••• •••• 3090</p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-col h-full justify-between relative overflow-hidden">
                  ...
                  <div className="space-y-1 relative z-10">
                    <div className="flex justify-between items-end">
                      ...
                      <span className="text-[9px] font-bold text-slate-800 tracking-wider">06/28</span>
                    </div>
                  </div>
                </div>
              </div>
